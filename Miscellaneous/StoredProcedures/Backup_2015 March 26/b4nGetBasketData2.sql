...
/****** Object:  Stored Procedure dbo.b4nGetBasketData2    Script Date: 23/06/2005 13:31:16 ******/


CREATE      procedure dbo.b4nGetBasketData2
...
AS
	...
	FROM 	b4nBasket 		b WITH(NOLOCK), 
		...
		b4nAttribute		 a WITH(NOLOCK)
		--#TemporaryTable 	tp WITH(NOLOCK)
	WHERE 	b.customerid 		= @nCustomerId
		AND b.storeid 		= @nStoreId
		--AND b.basketid 		= tp.basketid
...
GRANT EXECUTE ON b4nGetBasketData2 TO b4nuser
GO
GRANT EXECUTE ON b4nGetBasketData2 TO helpdesk
GO
GRANT EXECUTE ON b4nGetBasketData2 TO ofsuser
GO
GRANT EXECUTE ON b4nGetBasketData2 TO reportuser
GO
GRANT EXECUTE ON b4nGetBasketData2 TO b4nexcel
GO
GRANT EXECUTE ON b4nGetBasketData2 TO b4nloader
GO
