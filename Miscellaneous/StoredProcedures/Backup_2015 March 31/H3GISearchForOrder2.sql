...
CREATE PROCEDURE [dbo].[H3GISearchForOrder2]
...
SET @SQL = @SQL + '	LEFT OUTER JOIN h3giUpgrade UPG on UPG.upgradeId = 0 '
...
GRANT EXECUTE ON H3GISearchForOrder2 TO b4nuser
GO
GRANT EXECUTE ON H3GISearchForOrder2 TO ofsuser
GO
GRANT EXECUTE ON H3GISearchForOrder2 TO reportuser
GO
