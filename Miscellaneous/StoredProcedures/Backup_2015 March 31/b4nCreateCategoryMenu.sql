...
/****** Object:  Stored Procedure dbo.b4nCreateCategoryMenu    Script Date: 23/06/2005 13:31:05 ******/
...
CREATE        proc b4nCreateCategoryMenu
as
...
insert into #tmp(priority,menuid,parentmenuid,menutitle,menulink,menutarget,menulevel,usesimages,onPromotion,categoryImage)
select c.priority,rtrim(c.categoryid),c.parentcategoryid,ac.attributevalue, @shoppingLink + c.categoryid ,'_self',3,@UsesImagesType2,c.onPromotion,c.categoryImage
from b4ncategory c with(nolock), b4nattributecategory ac with(nolock)
...
GRANT EXECUTE ON b4nCreateCategoryMenu TO b4nuser
GO
