...
/*********************************************************************************************************************
**																					
** Procedure Name	:	threeGetUpgradeAccountByMsisdn
** Author			:	Simon Markey
** Date Created		:	
** Version			:	1.0.0
**					
...
**********************************************************************************************************************
**				
** Description		:	new stored procedure to search for business msisdns for upgrade orders
**					
**********************************************************************************************************************
**				
...
CREATE PROCEDURE [dbo].[threeGetUpgradeAccountByMsisdn]
	@MSISDN VARCHAR(13)
AS
BEGIN
...
GRANT EXECUTE ON threeGetUpgradeAccountByMsisdn TO b4nuser
GO
